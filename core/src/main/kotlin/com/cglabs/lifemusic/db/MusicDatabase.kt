...
package com.cglabs.lifemusic.db
...
import com.cglabs.lifemusic.db.daos.SpeedDialDao
import com.cglabs.lifemusic.db.entities.AlbumArtistMap
import com.cglabs.lifemusic.db.entities.AlbumEntity
...
import com.cglabs.lifemusic.db.entities.PlayCountEntity
import com.cglabs.lifemusic.db.entities.PlaylistEntity
import com.cglabs.lifemusic.db.entities.PlaylistSongMap
import com.cglabs.lifemusic.db.entities.PlaylistSongMapPreview
import com.cglabs.lifemusic.db.entities.RecognitionHistory
import com.cglabs.lifemusic.db.entities.RelatedSongMap
import com.cglabs.lifemusic.db.entities.SearchHistory
import com.cglabs.lifemusic.db.entities.SetVideoIdEntity
import com.cglabs.lifemusic.db.entities.SongAlbumMap
import com.cglabs.lifemusic.db.entities.SongArtistMap
import com.cglabs.lifemusic.db.entities.SongEntity
import com.cglabs.lifemusic.db.entities.SpeedDialItem
import com.cglabs.lifemusic.db.entities.SortedSongAlbumMap
import com.cglabs.lifemusic.db.entities.SortedSongArtistMap
import com.cglabs.lifemusic.extensions.toSQLiteQuery
...
val MIGRATION_44_45 =
    object : Migration(44, 45) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("ALTER TABLE beat_info ADD COLUMN contentEndMs INTEGER DEFAULT NULL")
        }
    }
