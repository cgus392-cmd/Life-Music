...
import com.cglabs.lifemusic.constants.MaxImageCacheSizeKey
import com.cglabs.lifemusic.constants.MaxSongCacheSizeKey
...
import com.cglabs.lifemusic.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    com.cglabs.lifemusic.playback.ExoDownloadService::class.java,
                    false
                )
