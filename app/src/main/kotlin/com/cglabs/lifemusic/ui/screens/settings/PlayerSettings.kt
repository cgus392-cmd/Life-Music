...
import com.cglabs.lifemusic.constants.EnableGoogleCastKey
...
import com.cglabs.lifemusic.constants.SeekExtraSeconds
...
import com.cglabs.lifemusic.constants.StopMusicOnTaskClearKey
import com.cglabs.lifemusic.constants.EnableExportAsMp3Key
...
highlightKey: String? = null) {
    ...
    val (dataSaverEnabled, onDataSaverEnabledChange) = rememberPreference(
        key = com.cglabs.lifemusic.constants.DataSaverEnabledKey,
        defaultValue = false
    )
    ...
    val (playbackEngine, onPlaybackEngineChange) = rememberEnumPreference(
        com.cglabs.lifemusic.constants.PlaybackEngineKey,
        defaultValue = com.cglabs.lifemusic.constants.PlaybackEngine.AUTO
    )

    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        com.cglabs.lifemusic.constants.DownloadQualityKey,
        defaultValue = com.cglabs.lifemusic.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            values = listOf(com.cglabs.lifemusic.constants.DownloadQuality.YOUTUBE),
            valueText = {
                when (it) {
    ...
    if (showPlaybackEngineDialog) {
        EnumDialog(
            ...
            onSelect = {
                ...
                com.cglabs.lifemusic.utils.YTPlayerUtils.playbackEngine = it
                showPlaybackEngineDialog = false
            },
            title = "Playback Engine",
            current = playbackEngine,
            values = listOf(
                com.cglabs.lifemusic.constants.PlaybackEngine.POTOKEN,
                com.cglabs.lifemusic.constants.PlaybackEngine.BRAVEPIPE,
                com.cglabs.lifemusic.constants.PlaybackEngine.AUTO,
            ),
            valueText = {
                when (it) {
                    com.cglabs.lifemusic.constants.PlaybackEngine.POTOKEN -> "PoToken (Recommended)"
                    com.cglabs.lifemusic.constants.PlaybackEngine.BRAVEPIPE -> "BravePipe (NewPipe)"
                    com.cglabs.lifemusic.constants.PlaybackEngine.AUTO -> "Auto (Try Both)"
                }
            },
            valueDescription = {
                when (it) {
                    com.cglabs.lifemusic.constants.PlaybackEngine.POTOKEN -> "Uses WebView PoToken + CipherDeobfuscator. Most reliable and future-proof."
                    com.cglabs.lifemusic.constants.PlaybackEngine.BRAVEPIPE -> "Uses NewPipe extractor for stream resolution. Lightweight but may break with YouTube updates."
                    com.cglabs.lifemusic.constants.PlaybackEngine.AUTO -> "Tries PoToken first, falls back to BravePipe if it fails."
                }
            }
        )
    }
