...
fun LibraryScreen(navController: NavController) {
    ...
    if (showYoutubeImportDialog) {
        ...
        com.cglabs.lifemusic.ui.component.TextFieldDialog(
    ...
    if (showCreatePlaylistDialog) {
        com.cglabs.lifemusic.ui.component.CreatePlaylistDialog(
    ...
    if (showAiPlaylistDialog) {
        com.cglabs.lifemusic.ui.component.CreateAiPlaylistDialog(
