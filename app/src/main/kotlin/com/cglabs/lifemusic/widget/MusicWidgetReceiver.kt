...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.cglabs.lifemusic.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.cglabs.lifemusic.widget.LIKE"
        const val ACTION_NEXT = "com.cglabs.lifemusic.widget.NEXT"
        const val ACTION_PREVIOUS = "com.cglabs.lifemusic.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.cglabs.lifemusic.widget.UPDATE_WIDGET"
    }
}
