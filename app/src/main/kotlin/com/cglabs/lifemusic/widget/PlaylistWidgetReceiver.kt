...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "com.cglabs.lifemusic.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.cglabs.lifemusic.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.cglabs.lifemusic.widget.playlists.UPDATE_WIDGET"
