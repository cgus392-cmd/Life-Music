...
import com.cglabs.lifemusic.recognition.MusicRecognitionService
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.cglabs.lifemusic.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "com.cglabs.lifemusic.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.cglabs.lifemusic.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.cglabs.lifemusic.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.cglabs.lifemusic.widget.recognizer.RESET"
    }
}
