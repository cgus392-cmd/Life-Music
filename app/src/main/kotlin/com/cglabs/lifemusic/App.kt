...
import com.cglabs.lifemusic.di.ApplicationScope
import com.cglabs.lifemusic.extensions.toEnum
import com.cglabs.lifemusic.extensions.toInetSocketAddress
import com.cglabs.lifemusic.utils.CrashHandler
import com.cglabs.lifemusic.utils.AppContextHolder
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        com.cglabs.lifemusic.utils.cipher.CipherDeobfuscator.initialize(this)
    ...
    private suspend fun initializeSettings() {
        ...
        val engineName = settings[com.cglabs.lifemusic.constants.PlaybackEngineKey]
        com.cglabs.lifemusic.utils.YTPlayerUtils.playbackEngine = try {
            if (engineName != null) com.cglabs.lifemusic.constants.PlaybackEngine.valueOf(engineName)
            else com.cglabs.lifemusic.constants.PlaybackEngine.AUTO
        } catch (_: Exception) { com.cglabs.lifemusic.constants.PlaybackEngine.AUTO }
    ...
    private fun observeSettingsChanges() {
        ...
        com.cglabs.lifemusic.utils.lastfm.LastFM.initialize(
