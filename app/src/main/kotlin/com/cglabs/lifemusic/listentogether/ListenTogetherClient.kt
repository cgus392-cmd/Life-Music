...
package com.cglabs.lifemusic.listentogether
...
import com.cglabs.lifemusic.constants.ListenTogetherAutoApprovalKey
import com.cglabs.lifemusic.constants.ListenTogetherIsHostKey
import com.cglabs.lifemusic.constants.ListenTogetherRoomCodeKey
import com.cglabs.lifemusic.constants.ListenTogetherServerUrlKey
import com.cglabs.lifemusic.constants.ListenTogetherSessionTimestampKey
import com.cglabs.lifemusic.constants.ListenTogetherSessionTokenKey
import com.cglabs.lifemusic.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.cglabs.lifemusic.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.cglabs.lifemusic.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.cglabs.lifemusic.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.cglabs.lifemusic.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.cglabs.lifemusic.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.cglabs.lifemusic.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
