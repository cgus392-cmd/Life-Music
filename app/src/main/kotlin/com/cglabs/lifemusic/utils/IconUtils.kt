...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "com.cglabs.lifemusic.MainActivityAlias")
        val static = ComponentName(context, "com.cglabs.lifemusic.MainActivityStatic")
        val legacy = ComponentName(context, "com.cglabs.lifemusic.MainActivityLegacy")
