...
import com.cglabs.lifemusic.utils.PlaybackLogLevel
...
import com.cglabs.lifemusic.utils.YTPlayerUtils.validateStatus
import com.cglabs.lifemusic.utils.potoken.PoTokenGenerator
import com.cglabs.lifemusic.utils.potoken.PoTokenResult
import com.cglabs.lifemusic.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
     ...
     */
    @Volatile
    var playbackEngine: com.cglabs.lifemusic.constants.PlaybackEngine = com.cglabs.lifemusic.constants.PlaybackEngine.AUTO
    ...
    private suspend fun findUrlOrNull(
        ...
        val useCipher = engine == com.cglabs.lifemusic.constants.PlaybackEngine.POTOKEN || engine == com.cglabs.lifemusic.constants.PlaybackEngine.AUTO
        if (useCipher) {
        ...
        val useBravePipe = engine == com.cglabs.lifemusic.constants.PlaybackEngine.BRAVEPIPE || engine == com.cglabs.lifemusic.constants.PlaybackEngine.AUTO
        if (useBravePipe) {
            if (skipNewPipe) {
