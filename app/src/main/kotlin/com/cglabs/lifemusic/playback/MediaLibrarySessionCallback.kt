...
import com.cglabs.lifemusic.constants.MediaSessionConstants
...
constructor(
                            ...
                            parentId.startsWith("${MusicService.YOUTUBE_PLAYLIST}/") -> {
                                ...
                                try {
                                    val songs = YouTube.playlist(playlistId).getOrNull()?.songs
                                        ...
                                        ?.filterVideoSongs(context.dataStore.get(HideVideoSongsKey, false) || context.dataStore.get(com.cglabs.lifemusic.constants.DataSaverEnabledKey, false))
                                        ?: emptyList()
    ...
    private fun com.cglabs.lifemusic.db.entities.Playlist.toBrowsableMediaItem() = browsableMediaItem(
